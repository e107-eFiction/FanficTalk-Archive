...
<body>
	<nav>
		...
		<ul class="menu">
			...
			<li><label for="drop-2" class="toggle"><h5>Account  <img src="images/arrow-red.png"></h5></label>
			...
			<li><label for="drop-1" class="toggle"><h5>Read  <img src="images/arrow-red.png"></h5></label>
			...
			<li><label for="drop-4" class="toggle"><h5>Hall of Fame  <img src="images/arrow-red.png"></h5></label>
			...
			<li><label for="drop-5" class="toggle"><h5>Help  <img src="images/arrow-red.png"></h5></label>
